/* ============================================================
   SEMESTER 2 — Subject Cards & Detail View
   Handles: Card clicks, showing/hiding sections, back navigation
   ============================================================ */
...
function initSubjectSearch() {
  const searchInput = document.querySelector('[data-search=".subject-section__list .note-item"]');
  if (!searchInput) return;

  const noteItems = document.querySelectorAll('.subject-section__list .note-item');
